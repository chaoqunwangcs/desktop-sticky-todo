  ...
  return (
    ...
    >
      ...
      <button
        {...attributes}
        {...listeners}
        className="mt-0.5 cursor-grab touch-none text-white/20 hover:text-white/50 active:cursor-grabbing"
        aria-label="拖拽排序"
        tabIndex={-1}
      >
      ...
      <div className="min-w-0 flex-1">
        {editing ? (
          ...
          <p
            ...
            className={cn(
              "cursor-text text-sm leading-snug text-white/90",
        ...
        {(todo.tag || todo.dueDate || countdown) && (
          <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-0.5 text-[11px]">
            ...
            {countdown && (
              <span
                className={cn(
                  countdown === "今天" ? "text-accent" : "text-white/40",
                )}
              >
                {countdown}
              </span>
